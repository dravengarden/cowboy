...
- [`releases/plugin-controller-buffer-owners-2026-09-15.md`](releases/plugin-controller-buffer-owners-2026-09-15.md) — Verified Controller candidate and 20 new tests; activation blocked by six missing upstream Agent publications
