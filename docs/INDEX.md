...
- [`unattended-release-adoption.md`](unattended-release-adoption.md) — Signature- and policy-anchored delivery without an operator session; Catalog watch implemented, signed intent and host policy designed
