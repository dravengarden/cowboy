export interface ProviderPublicationReceiptIdentity {
...
export interface ProviderPublicationReceipt
  extends ProviderPublicationReceiptIdentity {
  published_at: string;
}

export function resolveImmutableReceipt(
  identity: ProviderPublicationReceiptIdentity,
  existingText?: string,
  now = new Date(),
): { receipt: ProviderPublicationReceipt; text: string } {
