-- SQLite mirror of 0043_generic_provider_actions.sql. SQLite cannot replace a
-- CHECK constraint in place, so rebuild both small Provider-action tables while
-- preserving their rows and the action-log sequence.
