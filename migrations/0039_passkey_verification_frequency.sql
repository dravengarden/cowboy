...
-- predecessor columns as rollback ledgers because their CHECK constraints
-- cannot represent every new interval.

ALTER TABLE users
    ADD COLUMN passkey_verification_interval_ms bigint NOT NULL DEFAULT 86400000
        CHECK (
