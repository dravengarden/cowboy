...
const PUBLISHED_POSTGRES_MIGRATIONS: &[(&str, &str)] = &[
    (
        "0050_session_folders.sql",
        "a56258ad44f826b0500c52b58f6873c1dfac98e7832bf953b5b1febf3af8b948",
    ),
    (
        "0049_plugin_install_machine_receipts.sql",
        "ce8ee255ac026d5ff1afca688d7dc37b9b190e6e18644f0ad5f0ab9df5871890",
    ),
    (
        "0048_plugin_install_operations.sql",
        "24c92d06a18f32b3c107bf4e76447f3222feec55bc0ea62ba8a56fde78110fc5",
    ),
    (
        "0047_telemetry_binding_journal.sql",
        "28f07caec219a062912dbd70a8509bcbea61aaab37041c620209a5b7c8eab0e0",
    ),
    (
        "0046_core_security_authority.sql",
        "af17fd40ab38e2f56ce6d9eacbf1f6bc4c8a4031b46e81169ceff1c9a9704d49",
    ),
    (
...
const PUBLISHED_SQLITE_MIGRATIONS: &[(&str, &str)] = &[
    (
        "0024_session_folders.sql",
        "8035a0697405d131aa7601517f1fbfa2fb30590d78abe20d54ae1adbbd0c92ea",
    ),
    (
        "0023_plugin_install_machine_receipts.sql",
        "643ba9c1d35f94a25a7a419c098e914b8dae781e9b5658dc51fe6b1204eeb631",
    ),
    (
        "0022_plugin_install_operations.sql",
        "9e83dcda212742624a60120f2f16e395dd0ed4bfd5a87153c9e8a48a67bf9665",
    ),
    (
        "0021_telemetry_binding_journal.sql",
        "ddb740044b79fdcd98339009c4f50b558cf485ece35ab716382b5bda42180b73",
    ),
    (
        "0020_core_security_authority.sql",
        "524e1685797be55ce50241c509c655848d56d7f25175a2368364ce7af3c9d30e",
    ),
    (
