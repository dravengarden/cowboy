...
import {
  ...
  registerPasskey,
  verifyPasskey,
} from "../../../../web/src/auth/passkeyFlow.ts";
import { useProductAuth } from "../../../../web/src/auth/ProductAuthGate.tsx";
import { retryWithRecentProductAuth } from "../../../../web/src/auth/recentAuth.ts";
import {
  DEFAULT_PASSKEY_REAUTH_INTERVAL_MS,
  normalizePasskeyReauthInterval,
  PASSKEY_REAUTH_INTERVALS,
} from "../../../../web/src/auth/passkeyIntervals.ts";
import {
  configuredSessionProtectionItems,
  currentSessionProtectionItems,
  sessionDeadlineLabel,
  sessionPolicyDuration,
} from "../../../../web/src/auth/sessionProtection.ts";
const CARD_SX = {
  border: 1,
  borderColor: "divider",
  borderRadius: 3,
