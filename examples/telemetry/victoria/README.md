...
Installable data-only connector for existing VictoriaLogs and VictoriaMetrics
services; **not** a database/service installer. Neither is a default Cowboy
...
`{"version":"1.0.0","digest":"sha256:<composite artifact_digest>"}`.
