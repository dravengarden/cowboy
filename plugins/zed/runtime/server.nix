...
in platform.buildRustPackage {
  ...
  patches = [ ./server/dependencies.patch ./server/input-bounds.patch ./server/reload-bounds.patch ./server/acquisition-bounds.patch ./server/replacement-bounds.patch ];
  postPatch = ''
