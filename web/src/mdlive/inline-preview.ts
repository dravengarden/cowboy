...
// DO NOT EDIT by hand (except `// LOCAL:`-tagged lines logged in SYNC.md).
// @ts-nocheck — LOCAL: vendored third-party code, not re-typechecked under
// cowboy strict tsconfig (noUncheckedIndexedAccess flags upstream index access
// as noise; runtime is unaffected). Re-apply on every upstream sync. See SYNC.md.
