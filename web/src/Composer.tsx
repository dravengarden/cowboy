  ...
  return (
    <Box
      sx={{
        ...
        pl: { xs: "max(env(safe-area-inset-left), 14px)", sm: "max(env(safe-area-inset-left), 14px)" },
        pr: { xs: "max(env(safe-area-inset-right), 14px)", sm: "max(env(safe-area-inset-right), 14px)" },
        borderTop: 1,
        borderColor: "divider",
