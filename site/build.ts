...
const REQUIRED_ASSETS = [
  ...
  [
    ...
    "assets/cowboy-tab-icon-v6-16.png",
  ],
  [
    "site/assets/cowboy-tab-icon-v6-32.png",
    "assets/cowboy-tab-icon-v6-32.png",
  ],
  ["site/assets/cowboy-tab-icon-v6.ico", "assets/cowboy-tab-icon-v6.ico"],
