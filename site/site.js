...
const zhMessages = {
  ...
  "topology.intro":
    "Cowboy Hub 在已加入的 Machines 之间路由持久 Session。无需切换 IDE 或 SSH tab 即可切换主机；Desktop 与 Mobile 会重连同一个 worker，不移动也不停止它。",
  "topology.read": "阅读架构",
  ...
  "topology.yourMachine": "你的 Machine",
  "topology.connectNext": "连接下一台",
